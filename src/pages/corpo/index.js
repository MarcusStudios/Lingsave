...
export default function Corpo({ navigation }) {
    ...
    const loadImages = () => {
        const newImages = [
            { id: 1, uri: require('../../assets/3.png'), description: '3 - Cobrir o rosto com as mãos - Resposta negativa ao ouvir algo que não gostou ou está em desacordo.' },
            { id: 2, uri: require('../../assets/11.png'), description: '11 - Bocejar – Pode ser uma forma de alívio do estresse e controlar a ansiedade.' },
            { id: 3, uri: require('../../assets/7.png'), description: '7 - Movimentos que buscar acalmar o estresse, são movimentos pacificadores: a)Passa a língua na parte interna da bochecha b)Passa a língua nos lábios c)Espirar lentamente com as bochechas infladas' },
            { id: 4, uri: require('../../assets/9.png'), description: '9 - Assobios – São sons com intenção de acalmar.' },
