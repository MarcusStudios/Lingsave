...
export default function Pes({ navigation }) {
    ...
    const loadImages = () => {
        const newImages = [
            { id: 1, uri: require('../../assets/14.png'), description: '14 - Pés para frente e para trás – Podem determinar de acordo com o contexto impaciência' },
            { id: 2, uri: require('../../assets/16(1).png'), description: '16 - Ficar imóvel e não girar os pés e tronco para sua direção – É sinal de que não querem conversar ou não estão gostando da companhia ou estão com pressa' },
            { id: 3, uri: require('../../assets/18.png'), description: '18 - Apertar os joelhos na posição sentado inclinando ou não o tronco para frente – Significa que a pessoa já quer ir embora. ' },
            { id: 4, uri: require('../../assets/24.png'), description: '24 - Para de balançar ou chutar os pés (deixar imóvel por alguns instantes) – É um sinal de mudança emocional ou estar se sentindo ameaçada ' },
            { id: 5, uri: require('../../assets/25.png'), description: '25 - Cruzar os pés para baixa da cadeira, travar os tornozelos e rigidez do corpo – Indica sinal de desconforto, mal-estar, ansiedade ou preocupação.' },
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={[styles.title, { fontFamily: 'CustomFont' }]}>Galeria - Pés</Text>
            </View>
